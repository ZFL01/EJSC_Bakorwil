    ...
    <form action=\"{{ route('admin.clients.store') }}\" method=\"POST\" enctype=\"multipart/form-data\" class=\"space-y-4\">
        ...
        <div class=\"grid grid-cols-1 md:grid-cols-2 gap-4\">
            ...
            <div>
                ...
                <input type=\"text\" name=\"jenis_produk\" value=\"{{ old('jenis_produk') }}\" required class=\"w-full border rounded-lg p-2 text-sm focus:ring-2 focus:ring-[#56b8c2]\">
            </div>
            <div>
        ...
        <div class=\"grid grid-cols-1 md:grid-cols-2 gap-4\">
            <div>
                ...
                <input type=\"file\" name=\"url_foto_ktp\" class=\"text-xs text-gray-500\">
            </div>
            <div>
                <label class=\"block text-xs font-semibold text-gray-600 mb-1\">Foto Usaha/Produk</label>
                <input type=\"file\" name=\"url_foto_usaha\" class=\"text-xs text-gray-500\">
            </div>
        </div>
