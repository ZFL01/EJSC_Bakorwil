    ...
    <form action="{{ route('admin.mentors.update', $mentor->id_mentor) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="sosial_media" value="{{ old('sosial_media', $mentor->sosial_media) }}" placeholder="Instagram, Tiktok, Facebook" class="w-full border rounded-lg p-2 text-sm focus:ring-2 focus:ring-[#56b8c2]">
            </div>
        </div>
