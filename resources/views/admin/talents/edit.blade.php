        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                @if($talent->url_foto_ktp)
                    <p class="text-xs text-gray-500 mb-1">File saat ini: <a href="{{ asset('storage/' . $talent->url_foto_ktp) }}" target="_blank" class="text-[#56b8c2] underline">Lihat</a></p>
                @endif
            ...
            <div>
                ...
                @if($talent->url_cv)
                    <p class="text-xs text-gray-500 mb-1">File saat ini: <a href="{{ asset('storage/' . $talent->url_cv) }}" target="_blank" class="text-[#56b8c2] underline">Lihat</a></p>
                @endif
