                ...
                <div>
                    ...
                    <dd>
                        @if($talent->gdrive_src)
                            <a href="{{ $talent->gdrive_src }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1 text-xs text-rose-600 underline hover:text-rose-800">Buka Google Drive</a>
                        @else
